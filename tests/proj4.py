...
test_values = [
  {'name': 'tagFile', 'point_value': 5, 'timeout': 10},
  {'name': 'tagFile2', 'point_value': 5, 'timeout': 10},
  {'name': 'tagFile3', 'point_value': 5, 'timeout': 10},
  {'name': 'tagFile4', 'point_value': 5, 'timeout': 20},
  {'name': 'tagFile5', 'point_value': 5, 'timeout': 10},
  ...
  {'name': 'ec-tagFile7', 'point_value': 2, 'timeout': 10},
  {'name': 'ec-getAllTags', 'point_value': 2, 'timeout': 10},
  {'name': 'ec-getAllTags2', 'point_value': 2, 'timeout': 10},
  {'name': 'ec-getFilesByTag', 'point_value': 2, 'timeout': 10},
  {'name': 'ec-getFilesByTag2', 'point_value': 2, 'timeout': 10},
  {'name': 'ec-arbitraryLength', 'point_value': 2, 'timeout': 10},
  ...
  {'name': 'ec-manyBlocks3', 'point_value': 2, 'timeout': 90},
